...
const contacts = [
  ...
  { icon: <HiLocationMarker className="h-4 w-4" />, text: "Setif, Algeria" },
];
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#050200] text-gray-400 overflow-hidden">

      {/* Background grid */}
      <div
        className="absolute inset-0 opacity-[0.03] pointer-events-none"
        style={{
          backgroundImage: `linear-gradient(rgba(244,194,31,0.6) 1px, transparent 1px), linear-gradient(90deg, rgba(244,194,31,0.6) 1px, transparent 1px)`,
        ...
        <div className="px-6 md:px-16 py-14 flex flex-col md:flex-row items-center justify-between gap-8 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col gap-3 text-center md:text-left">
            <div className="flex items-center gap-2 justify-center md:justify-start">
              ...
              <span className="text-xs font-bold tracking-[0.3em] text-[#E87722] uppercase">Newsletter</span>
            </div>
            ...
            <p className="text-gray-500 text-sm max-w-sm">
              Get product updates, merchant success stories, and exclusive offers straight to your inbox.
            </p>
          </div>
          ...
          <div className="w-full md:w-auto">
            {subscribed ? (
              <div className="flex items-center gap-3 px-6 py-4 bg-green-500/10 border border-green-500/30 rounded-2xl">
                ...
                <span className="text-green-400 font-bold text-sm">You're subscribed! Welcome aboard 🎉</span>
              </div>
            ) : (
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                ...
                >
                  Subscribe
                  <HiArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform duration-200" />
                </button>
              </div>
            )}
          </div>
          ...
          <div className="flex flex-col gap-8 max-w-xs">
            ...
            <div className="flex flex-col gap-4">
              <img
                ...
                alt="Bazario Logo"
                className="h-25 w-auto brightness-200"
              />
              <p className="text-sm leading-relaxed text-gray-500">
                Bazario empowers merchants across Algeria and beyond to launch
                professional online stores — fast, simple, and affordable.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={stat.label}
                  className="flex flex-col gap-1 p-3 rounded-xl bg-white/[0.03] border border-white/5"
                >
                  <span className="text-xl font-black bg-gradient-to-r from-[#E87722] to-[#F4C21F] bg-clip-text text-transparent">
                    {stat.value}
                  </span>
            ...
            <div className="flex flex-col gap-2.5">
              {contacts.map((c) => (
                <div
                  key={c.text}
                  className="flex items-center gap-3 text-sm text-gray-500 hover:text-[#E87722] transition-colors duration-200 cursor-pointer group"
                >
                  <div className="text-[#E87722] group-hover:scale-110 transition-transform duration-200">
                    {c.icon}
                  </div>
                  {c.text}
                </div>
              ...
              <div key={category} className="flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                  ...
                  <div
                    ...
                    style={{ background: "linear-gradient(to right, #E87722, transparent)" }}
                  />
                </div>
                <ul className="flex flex-col gap-2.5">
                  {links.map((link) => (
                    <li
                      key={link}
                      className="group flex items-center gap-1.5 text-sm text-gray-500 cursor-pointer hover:text-[#E87722] transition-all duration-200"
                    >
      ...
      <div className="border-t border-white/5">
        <div className="px-6 md:px-16 py-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>© 2026 Bazario. All rights reserved.</span>
          </div>

          <div className="flex items-center gap-6 text-xs text-gray-600">
            <span className="hover:text-[#E87722] cursor-pointer transition-colors duration-200">Privacy</span>
            <span className="hover:text-[#E87722] cursor-pointer transition-colors duration-200">Terms</span>
            <span className="hover:text-[#E87722] cursor-pointer transition-colors duration-200">Cookies</span>
            <span className="h-3 w-px bg-white/10" />
            <p>
              Made with Tizart in{" "}
              <span className="bg-gradient-to-r from-[#E87722] to-[#F4C21F] bg-clip-text text-transparent font-black">
                Algeria 🇩🇿
              </span>
            </p>
          </div>
